...
e.g.:
    $ python3 networks/vort_matrix.py SWE --segments=1 data/model/SWE_snapshots/SWE_snapshots_s1.h5 --output=data/vort/SWE

Usage:
    dep_matrix.py <model> [--segments=<seg>]  <files> [--output=<dir>]

"""
====================================================================================================
ECMWF's ERA5 Data Retreival Scrip
====================================================================================================
Run requests for ECMWF's ERA5 dataset and store them in netcdf files.
----------------------------------------------------------------------------------------------------
"""
...
for i, year in enumerate(yarr):
    ...
    for month in marr:
        ...
        c.retrieve(DATASET, r, f"../../../data/ERA5/Y{year}M{month:02d}-daily-NH-850K.nc")

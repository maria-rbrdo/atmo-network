...
def main(in_nu=1e5, in_umax=80, in_hpert=120, in_nmodes=2**6, savefolder="../data/model/SWE_snapshots"):
    ...
    # Select parameters:
    my_nu = in_nu * meter**2 / second # diffusion coefficient -> 1e5 m^2/s
    my_umax = in_umax * meter / second  # maximum zonal velocity -> 80 m/s
    my_hpert = in_hpert * meter  # perturbation amplitude -> 120 m

    nmodes = in_nmodes  # number of spectral modes (powers of two are computationally efficient)
    ...
    umax = my_umax # maximum zonal velocity
    ...
    hpert = my_hpert  # perturbation amplitude
    ...
    #%% Analysis
    snapshots = solver.evaluator.add_file_handler(savefolder, iter=int(10 * 60 * second / timestep),
